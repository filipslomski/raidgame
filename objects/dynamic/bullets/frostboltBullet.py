...
class FrostboltBullet(Bullet):

    image_path = "images/bullets/frostbolt_bullet.jpg"

    def __init__(self, speed, start_position, target_position, damage):
        super(FrostboltBullet, self).__init__(speed, start_position, target_position, damage)
